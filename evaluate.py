...
def ams_score(y_true: Sequence[Union[int, str]], y_pred: Sequence[Union[int, str]], weights, br: float = 10.0) -> float:
    """Compute the Approximate Median Significance (AMS) metric.

    Accepts y_true / y_pred encoded as 's'/'b' or 1/0. weights should be numeric.
    """
